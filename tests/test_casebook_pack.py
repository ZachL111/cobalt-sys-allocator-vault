"""Regression checks for the cobalt-sys-allocator-vault casebook."""
...
from casebook.harness import assert_expected, cobalt_sys_allocator_vault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cobalt_sys_allocator_vault_summary(), assert_expected())
